              ...
              children: [
                ...
                TableRow(
                  children: [
                    ...
                    Text(_motionEvent?.userAcceleration.vector.x
                            .toStringAsFixed(1) ??
                        '?'),
                    Text(_motionEvent?.userAcceleration.vector.y
                            .toStringAsFixed(1) ??
                        '?'),
                    Text(_motionEvent?.userAcceleration.vector.z
                            .toStringAsFixed(1) ??
                        '?'),
                    Text(
                ...
                TableRow(
                  children: [
                    ...
                    Text(
                        _magnetometerEvent?.vector.x.toStringAsFixed(1) ?? '?'),
                    Text(
                        _magnetometerEvent?.vector.y.toStringAsFixed(1) ?? '?'),
                    Text(
                        _magnetometerEvent?.vector.z.toStringAsFixed(1) ?? '?'),
    ...
    _streamSubscriptions.add(
      motionEventStream(samplingPeriod: sensorInterval).listen(
        (MotionEvent event) {
          ...
          setState(() {
            _motionEvent = event;
            // print('liu: ts: ${_motionEvent?.timestamp}');
